...
Rename the `Auth0.plist.example` file to `Auth0.plist`, and replace the `aRhJa59DVCRZVmsI9v4pLBVGRNXRoYyo` and `nelson.jp.auth0.com` placeholders with the Client ID and domain of your Auth0 application.
